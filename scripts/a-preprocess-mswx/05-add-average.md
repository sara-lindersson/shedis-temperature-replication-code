...
This script calculates the average values (timmean) for each grid cell
from the original daily maximum (TX) and minimum (TN) temperature time
series. It then adds these average values to the detrended TN and TX
time series.
