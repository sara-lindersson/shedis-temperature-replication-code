---
title: 'Extracting data on population and land area'
author: 'Sara Lindersson'
date: '`r Sys.Date()`'
output: github_document
---

This script extracts data on yearly population figures and the area of disaster-affected administrative units (polygons from GADM) for each event. It then joins this data with the meteorological daily statistics.
...
The script will now resample the population maps from the Global Human Settlement Layer to align with the grid cells of MSWX (the meteorological data). Various methods exist for resampling rasters in R; for instance, one could use the libraries _terra_ or _exactextractr_. While both methods yield similar results, _terra_ also produces NA values. Therefore, I have chosen to resample using _exactextractr_.
