---
title: 'Threshold Analysis at Grid Cell Level'
author: 'Sara Lindersson'
date: '`r Sys.Date()`'
output: github_document
---

This script identifies periods of heat waves and cold waves at the grid cell level through threshold analysis, conducted per administrative unit. The final output is one .csv file per disaster number, containing identified events at the grid cell level based on the selected thresholds.
...
__Note__: The variable denoted as _temp_ refers to the 2-m air temperature as provided by [MSWX](https://doi.org/10.1175/BAMS-D-21-0145.1). The heat stress variables indicated as _at_, _wbt_ and _swbgt_ have been calculated from MSWX data using the R package [HeatStress](https://rdrr.io/github/anacv/HeatStress/).
...
The script now gathers the event data (at grid cell level) to one file per disaster number (disno).
