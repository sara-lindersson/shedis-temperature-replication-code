---
title: 'Attributes at the Grid Cell Level'
author: 'Sara Lindersson'
date: '`r Sys.Date()`'
output: github_document
---

This script derives data attributes at the grid cell level for each administrative unit and disaster number. The outputs from this script include:  
+ _data-grid-cell-level.csv_: This file contains the derived data attributes.  
+ _data-grid-cell-level.gpkg_: This file includes both the data attributes and a simplified polygon of the corresponding administrative unit (sourced from GADM v 3.6).
