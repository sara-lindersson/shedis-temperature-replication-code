---
title: 'Attributes on administrative unit level'
author: 'Sara Lindersson'
date: '`r Sys.Date()`'
output: github_document
---

This script derives attributes at the disaster record level. The outputs from this script include:  
+ _data-disno-level.csv_: This file contains the derived data attributes.  
+ _data-disno-level.gpkg_: This file includes both the data attributes and simplified polygon(s) of the corresponding administrative unit(s) (sourced from GADM v 3.6).
...
```{r load-subnat, warning=F, message=F, results=F}
